...
const TREE := [
	...
	{"id":"sword_thunder_spin", "name":"雷霆旋风斩", "page":"战斗", "family":"刀剑", "pos":Vector2(460,80),
	 "type":"组合", "max":1, "cost":2, "req":["atk"], "weapon_required":"sword",
	 "desc":"第三段剑式卷起三重雷弧，扩大终结范围并短暂牵引轻型敌人。",
	 "usage":"装备刀剑连续按 J 三次；第三击会释放雷霆旋风，适合近身解围。",
	 "input":"J → J → J", "preview":"spin", "preview_pattern":"slash_spin", "preview_intensity":"signature"},
	{"id":"sword_shadow_dragon", "name":"无影狂龙斩", "page":"战斗", "family":"刀剑", "pos":Vector2(600,340),
	 "type":"终结", "max":1, "cost":3, "req":["spin","ultimate"], "weapon_required":"sword",
	 "desc":"化作连续残影贯穿战线，最后以升龙雷斩引爆全部剑痕。",
	 "usage":"怒气充满后双击方向并按 K，突进命中后按 V 释放终结斩。",
	 "input":"→ → + K，命中后 V", "preview":"ultimate", "preview_pattern":"shadow_dash", "preview_intensity":"ultimate"},
	{"id":"hammer_temper", "name":"熔炉淬体", "page":"战斗", "family":"铁锤", "pos":Vector2(300,80),
	 "type":"被动", "max":3, "cost":1, "req":[], "weapon_required":"hammer",
	 "desc":"铁锤蓄力期间减伤 +8%/级。", "usage":"装备铁锤按住 K 蓄力时自动生效。",
	 "input":"按住 K", "preview":"hammer_attack"},
	{"id":"hammer_momentum", "name":"惯性增幅", "page":"战斗", "family":"铁锤", "pos":Vector2(300,360),
	 "type":"被动", "max":3, "cost":1, "req":["hammer_temper"], "weapon_required":"hammer",
	 "desc":"完整蓄力重击的破甲与击退逐级提高。", "usage":"完整蓄力后松开 K，命中时自动生效。",
	 "input":"按住 K → 松开", "preview":"hammer_attack"},
	{"id":"hammer_core_burst", "name":"熔核震爆", "page":"战斗", "family":"铁锤", "pos":Vector2(460,300),
	 "type":"主动", "max":3, "cost":1, "req":["hammer_demolition"], "weapon_required":"hammer",
	 "desc":"向下砸出熔核震环，伤害、破甲和地裂范围随等级提升。",
	 "usage":"装备铁锤按 ↓ + K；可压制贴地敌群并震开橙色脆岩。",
	 "input":"↓ + K", "preview":"hammer_attack", "preview_pattern":"ground_smash", "preview_intensity":"signature"},
	{"id":"hammer_rail_drive", "name":"磁轨飞锤", "page":"战斗", "family":"铁锤", "pos":Vector2(560,120),
	 "type":"组合", "max":1, "cost":2, "req":["hammer_core_burst","hammer_temper"], "weapon_required":"hammer",
	 "desc":"磁轨线圈牵引重锤横贯战线，并把命中目标拖向回收点。",
	 "usage":"完整蓄力后双击方向并按 K；锤头飞出后自动磁吸回收。",
	 "input":"蓄力 → → → + K", "preview":"hammer_attack", "preview_pattern":"shadow_dash", "preview_intensity":"signature"},
	{"id":"cannon_pressure_core", "name":"压力稳压器", "page":"战斗", "family":"蒸汽枪炮", "pos":Vector2(300,80),
	 "type":"被动", "max":3, "cost":1, "req":[], "weapon_required":"cannon",
	 "desc":"枪炮过热增长 -10%/级。", "usage":"装备蒸汽枪炮射击时自动生效。",
	 "input":"J / K", "preview":"cannon_attack"},
	{"id":"cannon_reflux", "name":"余汽回流", "page":"战斗", "family":"蒸汽枪炮", "pos":Vector2(300,360),
	 "type":"被动", "max":3, "cost":1, "req":["cannon_pressure_core"], "weapon_required":"cannon",
	 "desc":"技能命中后返还少量技力，等级越高返还越多。", "usage":"枪炮主动技能命中时自动触发。",
	 "input":"主动技能命中", "preview":"cannon_attack"},
	{"id":"cannon_overpressure_rise", "name":"过压升焰", "page":"战斗", "family":"蒸汽枪炮", "pos":Vector2(500,80),
	 "type":"主动", "max":3, "cost":1, "req":["cannon_steam_jet"], "weapon_required":"cannon",
	 "desc":"向下喷射高压蒸汽并浮空，火柱高度与滞空时间随等级提升。",
	 "usage":"装备蒸汽枪炮按 ↑ + K；战斗中挑空敌人，蒸汽锚附近可辅助升高。",
	 "input":"↑ + K", "preview":"jump", "preview_pattern":"pressure_jet", "preview_intensity":"signature"},
	{"id":"cannon_star_pressure", "name":"贯星压力炮", "page":"战斗", "family":"蒸汽枪炮", "pos":Vector2(560,340),
	 "type":"终结", "max":1, "cost":3, "req":["cannon_overpressure_rise","cannon_pressure_core"], "weapon_required":"cannon",
	 "desc":"锁定直线后释放多段贯穿压力束，末端蒸汽爆炸造成高额破甲。",
	 "usage":"怒气充满后按 ↓ + K 锁定，再按 V 释放贯穿炮。",
	 "input":"↓ + K → V", "preview":"ultimate", "preview_pattern":"pressure_beam", "preview_intensity":"ultimate"},
	{"id":"dual_mirror_storm", "name":"镜影风暴", "page":"战斗", "family":"双刀", "pos":Vector2(520,80),
	 "type":"组合", "max":1, "cost":2, "req":["dual_cross"], "weapon_required":"dual_blades",
	 "desc":"高速穿梭留下四道镜影，镜影延迟交叉斩击同一目标。",
	 "usage":"双击方向并按 K 穿身，落地前再按 J 召回镜影斩。",
	 "input":"→ → + K → J", "preview":"dual_combo", "preview_pattern":"cross_slash", "preview_intensity":"signature"},
	{"id":"dual_rift_prison", "name":"裂空瞬狱", "page":"战斗", "family":"双刀", "pos":Vector2(600,220),
	 "type":"终结", "max":1, "cost":3, "req":["dual_execution"], "weapon_required":"dual_blades",
	 "desc":"以环形刃痕封锁敌群，短暂停顿后从八向同时处决。",
	 "usage":"怒气充满后按 V；刃痕范围内的敌人会在终结帧同时受击。",
	 "input":"怒气满 → V", "preview":"ultimate", "preview_pattern":"cross_slash", "preview_intensity":"ultimate"},
	{"id":"spear_skywheel_rise", "name":"天轮升龙", "page":"战斗", "family":"长枪", "pos":Vector2(500,80),
	 "type":"主动", "max":3, "cost":1, "req":["spear_mastery"], "weapon_required":"spear",
	 "desc":"旋枪形成上升齿轮，把敌人带入空中并衔接空战。",
	 "usage":"装备长枪按 ↑ + K；命中后可在空中用 J 继续连刺。",
	 "input":"↑ + K", "preview":"spear_combo", "preview_pattern":"spear_rise", "preview_intensity":"signature"},
	{"id":"spear_dragon_drill", "name":"龙脊钻星", "page":"战斗", "family":"长枪", "pos":Vector2(600,300),
	 "type":"组合", "max":1, "cost":2, "req":["spear_dragon"], "weapon_required":"spear",
	 "desc":"枪尖化作龙脊钻头持续推进，命中薄壁或重甲时产生终段爆裂。",
	 "usage":"双击方向并按 K，持续按住方向推进；可钻穿明确标记的薄型机械壁。",
	 "input":"→ → + K（按住方向）", "preview":"spear_combo", "preview_pattern":"spear_drill", "preview_intensity":"signature"},
	{"id":"crossbow_rift_rain", "name":"裂隙箭雨", "page":"战斗", "family":"弓弩", "pos":Vector2(500,80),
	 "type":"主动", "max":3, "cost":1, "req":["crossbow_burst"], "weapon_required":"crossbow",
	 "desc":"向空中射出裂隙母箭，随后在锁定区降下多轮穿透箭雨。",
	 "usage":"装备弓弩按 ↓ ↓ + K；地面出现锁定圈后可用方向调整落点。",
	 "input":"↓ ↓ + K", "preview":"crossbow_combo", "preview_pattern":"arrow_rain", "preview_intensity":"signature"},
	{"id":"crossbow_hunter_terminal", "name":"猎杀终端", "page":"战斗", "family":"弓弩", "pos":Vector2(600,220),
	 "type":"终结", "max":1, "cost":3, "req":["crossbow_barrage"], "weapon_required":"crossbow",
	 "desc":"扫描并标记视野内目标，终端倒计时结束后同步引爆弱点。",
	 "usage":"怒气充满后按 V；准星锁定期间保持敌人在视野内以提高终段伤害。",
	 "input":"怒气满 → V", "preview":"ultimate", "preview_pattern":"reticle_burst", "preview_intensity":"ultimate"},
]
